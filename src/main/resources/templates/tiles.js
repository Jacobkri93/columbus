...
function createTileObjectTest(x,y,tileType,mp) {

    let tileTest = {
        id: undefined, x_pos: x, y_pos: y, tile_at_point_one: false, tile_at_point_two: false,
        tile_at_point_three: false, tile_at_point_four: false, tile_at_point_five: false, tile_at_point_six: false,
        tile_type: tileType, movement_points: mp, id_civ: 7, civ_name: "none", attitude: null
    }
...
function createTileObject(x,y,tile1,tile2,tile3,tile4,tile5,tile6,tileType,mp,civID,civName,att) {

    let tileTest = {
        id: undefined, x_pos: x, y_pos: y, tile_at_point_one: tile1, tile_at_point_two: tile2,
